...
import com.android.parsenotifications.helper.PrefManager;
import com.android.parsenotifications.model.Message;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for data handle code
        //ParseObject testObject = new ParseObject("TestObject");
        //testObject.get("foo");
        //testObject.fetchInBackground();
        //System.out.println("Parse= "+testObject.get("foo"));
        //testObject.saveInBackground();
        ParseQuery<ParseObject> query= ParseQuery.getQuery("test");
        query.getInBackground("fchpZwSuGG", new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject arg0, ParseException arg1) {
                ...
                if (arg1==null)
                {
                    String txt = arg0.getString("playerName");
